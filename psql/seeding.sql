...
('NW1-F1-Entrance-Mixed', 'NW1 floor 1, near entrance', 'NW1', 1, 49.2821, -123.1208, 0),
('NW1-F1-Entrance-Garbage', 'NW1 floor 1, near entrance', 'NW1', 1, 49.2822, -123.1209, 100),
('NW2-F2-Labs-Organic', 'NW2 floor 2, near labs', 'NW2', 2, 49.2830, -123.1215, 0),
...
('NW3-F1-Cafeteria-Garbage', 'NW3 floor 1, near cafeteria', 'NW3', 1, 49.2842, -123.1227, 0);

-- Quadrant: NE (Buildings 1–10 for brevity)
INSERT INTO smart_trashcan.trashcans (name, location, building, floor, latitude, longitude, status) VALUES
('NE1-F1-Entrance-Organic', 'NE1 floor 1, near entrance', 'NE1', 1, 49.2820, -123.1007, 0),
('NE1-F1-Entrance-Mixed', 'NE1 floor 1, near entrance', 'NE1', 1, 49.2821, -123.1008, 0),
('NE1-F1-Entrance-Garbage', 'NE1 floor 1, near entrance', 'NE1', 1, 49.2822, -123.1009, 100),
('NE2-F2-Labs-Organic', 'NE2 floor 2, near labs', 'NE2', 2, 49.2830, -123.1015, 0),
...
('NE3-F1-Cafeteria-Garbage', 'NE3 floor 1, near cafeteria', 'NE3', 1, 49.2842, -123.1027, 0);

-- Quadrant: SW (Buildings 1–5 for brevity)
INSERT INTO smart_trashcan.trashcans (name, location, building, floor, latitude, longitude, status) VALUES
('SW1-F1-Entrance-Organic', 'SW1 floor 1, near entrance', 'SW1', 1, 49.2700, -123.1307, 100),
('SW1-F1-Entrance-Mixed', 'SW1 floor 1, near entrance', 'SW1', 1, 49.2701, -123.1308, 0),
('SW1-F1-Entrance-Garbage', 'SW1 floor 1, near entrance', 'SW1', 1, 49.2702, -123.1309, 0),
('SW2-F2-Labs-Organic', 'SW2 floor 2, near labs', 'SW2', 2, 49.2710, -123.1315, 0),
...
('SE1-F1-Entrance-Mixed', 'SE1 floor 1, near entrance', 'SE1', 1, 49.2701, -123.1008, 0),
('SE1-F1-Entrance-Garbage', 'SE1 floor 1, near entrance', 'SE1', 1, 49.2702, -123.1009, 100),
('SE2-F2-Labs-Organic', 'SE2 floor 2, near labs', 'SE2', 2, 49.2710, -123.1015, 0),
...
('SE3-F1-Cafeteria-Garbage', 'SE3 floor 1, near cafeteria', 'SE3', 1, 49.2722, -123.1027, 0);
